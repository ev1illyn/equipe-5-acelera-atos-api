...
public interface LogisticaRepository extends PagingAndSortingRepository<OrdemServicoEntity, Long> {
	...
	public Optional<OrdemServicoEntity> findByIdCliente(Long idCliente);
	
	public Page<OrdemServicoEntity> findByDataNascimentoBetween(@NotNull LocalDate inicio, @NotNull LocalDate fim, Pageable pageable); 
}
